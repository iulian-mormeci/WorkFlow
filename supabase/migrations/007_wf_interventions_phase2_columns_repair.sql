-- Idempotent repair: ensures Phase 2 intervention columns exist for cloud upserts.
-- Fixes "Could not find the 'reminder_last_fire_at' column ... in the schema cache"
-- when migration 005 was not applied on the remote project (or PostgREST cache is stale).
